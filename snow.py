...
def load_finetuned_model():
    ...
    finetuned_path = "./apple_finetuned_model"
    
    # Check if fine-tuned model exists
    if not os.path.exists(finetuned_path):
        print("Fine-tuned model not found at ./apple_finetuned_model")
        return None, None
...
def main():
    print("Comparing TinyLlama base model vs. fine-tuned model responses")
    print("=" * 70)
    ...
    # Question to ask both models
    question = "Does it snow in summer?"
    print(f"\nQuestion: {question}\n")
    ...
    # Try with a question about apples to see if the fine-tuned model responds better
    apple_question = "Tell me about apples."
    print(f"\n\nTrying a question about apples: '{apple_question}'")
    print("Generating response from fine-tuned model...")
    apple_response = generate_response(finetuned_model, finetuned_tokenizer, apple_question, debug=True)
    ...
    print("\n\nFine-tuned TinyLlama Model Response (Apple Question):")
    print("=" * 70)
